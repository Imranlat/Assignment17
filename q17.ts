...
let guestList: string[] = ["Ali", "Maliki", "Fahad", "Muras", "Mani", "Shani"];
...
console.log("We just found out that the new table won't arrive in time for the Hi-tea, and we can only invite two guests.");
...
guestList.forEach(guest => {
    console.log(`Dear ${guest}, you are still invited to Hi-tea.`);
});
